...
public class gatherMain extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleDateFormat strFormate = new SimpleDateFormat("yyyy-MM-dd");
        bt_bir.setText(strFormate.format(new Date()));
        ...
        bt_next.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if ((dcs_name.getText().length() > 0) && (dcs_address.getText().length() > 0) && (bt_bir.getText().length() > 0) && (bt_gender.getText().length() > 0)) {
        ...
        bt_gender.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new AlertDialog.Builder(gatherMain.this)
                        ...
                        .setSingleChoiceItems(new String[]{"Male", "Female"}, selectedID,
