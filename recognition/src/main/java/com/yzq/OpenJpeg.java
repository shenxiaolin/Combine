...
public class OpenJpeg {
    ...
    * 返回值: 0,成功; 其他,失败
    *  */
    public native int CompressImage(String inputFilePathAndName, String outputFilePathAndName, String CompressRatio);
    ...
    * 返回值: 0,成功; 其他,失败
    * */
    public native int DecompressImage(String inputFilePathAndName, String outputFilePathAndName);
