...
public class MainActivity_V extends Activity {
	...
	//wentong
	// dcs
//	private AuthService.authBinder authBinder;//moubiao
...
//							getResources().getString(R.string.fieldname002) + ReturnAuthority,
//							Toast.LENGTH_SHORT).show();
//				} else {
//					Toast.makeText(getApplicationContext(),getResources().getString(R.string.fieldname001),
//							Toast.LENGTH_SHORT).show();
//				}
//			} catch (Exception e) {
//				Toast.makeText(getApplicationContext(),getResources().getString(R.string.fieldname002),
//						Toast.LENGTH_SHORT).show();
//
//			} finally {
//				if (authBinder != null) {
...
//				if (ReturnAuthority != 0) {
//					
//					String text = getString(R.string.fieldname002) + " : ";
//					
//					if(ReturnAuthority == -10004){
//						text = text + getString(R.string.fieldname0001);
//					}else if(ReturnAuthority == -10005){
//						text = text + getString(R.string.fieldname0002);
//					}else if(ReturnAuthority == -10006){
//						text = text + getString(R.string.fieldname0003);
//					}else if(ReturnAuthority == -10007){
//						text = text + getString(R.string.fieldname0004);
//					}else if(ReturnAuthority == -10008){
//						text = text + getString(R.string.fieldname0005);
//					}else if(ReturnAuthority == -10013){
//						text = text + getString(R.string.fieldname0006);
//					}else if(ReturnAuthority == -10014){
//						text = text + getString(R.string.fieldname0006);
//					}else if(ReturnAuthority == -10015){
//						text = text + getString(R.string.fieldname0009);
//					}else if(ReturnAuthority == -10017){
//						text = text + getString(R.string.fieldname0010);
//					}
//					
//					Toast.makeText(getApplicationContext(),
...
//					
//				} else {
//					Toast.makeText(getApplicationContext(),getString(R.string.fieldname001),
//							Toast.LENGTH_SHORT).show();
//				}
//			} catch (Exception e) {
...
//		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("huangmin","application = "+application);
		...
		ENTRY_NAME_NUM = 25;//mVoteDB_log.ENTRY_NAME_NUM;
		...
		type = getResources().getStringArray(R.array.textcardtype_array);
		...
		mbuttonPerson.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
					...
					Intent it = new Intent(MainActivity_V.this, person.class);
					startActivity(it);
						
						//Intent it = new Intent(MainActivity_V.this, MainActivity_rftest.class);
						//startActivity(it);
		...
		mbuttonDataQuery.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
              ...
              intent.setClassName("com.example.jy.demo.fingerprint",    
                      "com.example.jy.demo.fingerprint.ConsoleActivity");     
              startActivity(intent);  
				
//				Intent it = new Intent(MainActivity_V.this, DataSend.class);
//				startActivity(it);
		...
		mbuttonLockVote.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!application.isConnect()) {
					startActivity(new Intent(MainActivity_V.this, ConnectActivity.class));
					return;
				}
				startActivity(new Intent(MainActivity_V.this, SFZActivity.class));
				//sacn
...
//				}
				...
				dialog_bt_ok.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Intent authIntent = new Intent(MainActivity_V.this, AuthService.class);
...
//		});
		...
		mbuttonDataTransmit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent it = new Intent(MainActivity_V.this, VinQuery.class);
				startActivity(it);
...
//				
//				new AlertDialog.Builder(MainActivity_V.this) 
//				.setTitle("��ѡ��")  
...
//				        
//						Intent mintent = new Intent(MainActivity_V.this,CameraActivity.class);
...
//				});
		...
		mbuttonAbout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
//				Intent it = new Intent(MainActivity_V.this, SystemAbout.class);
//				startActivity(it);
	            Intent intent = new Intent();
				...
				//wt dcs
				/*new AlertDialog.Builder(MainActivity_V.this) 
				.setTitle(getResources().getString(R.string.textcardtype))
				.setIcon(android.R.drawable.ic_dialog_info)                  
				.setSingleChoiceItems(type, 0,   
				  new DialogInterface.OnClickListener() {  
	...
	private void initDialogView() {
		...
		dlg = new AlertDialog.Builder(MainActivity_V.this).create();
		dlg.show();
